...
この画像の書類の種類を判定し、全ての数値データを抽出してJSON形式で返してください。
...
【返却フォーマット】
{
  "documentType": "pl" | "bs" | "manufacturing_cost" | "sga_detail" | "depreciation" | "payroll" | "tax_return" | "other",
  "detectedTitle": "書類タイトル",
  "items": [
    { "label": "項目名", "value": "値テキスト", "numericValue": 数値 | null, "confidence": 0-100 }
  ],
  "notes": "特記事項"
}`;
